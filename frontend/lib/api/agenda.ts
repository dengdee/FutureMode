...
import type { AgendaItemCreateRequest, AgendaItemResponse, AgendaItemUpdateRequest } from "../../types/api";
...
export function listAgendaItems(meetingId: string) { return request<AgendaItemResponse>(() => http.get(`/api/v1/meetings/${meetingId}/agenda`)); }
