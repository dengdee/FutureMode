...
export type PreparationDocument = { meeting_id: string; document_id: string; name: string; content: string; status: string; generated_at: string };
export type PreparationPublishResult = { meeting_id: string; document_id: string; status: string; chunk_count: number; published_at: string };
