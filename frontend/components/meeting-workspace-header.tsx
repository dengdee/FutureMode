  ...
  return (
    <div className="border-b border-[#e6e6e3] pb-6">
      ...
      <div className="mt-5 flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
        <div><p className="text-sm font-medium text-[#2f6f5e]">{phaseLabel}</p><h1 className="mt-2 text-3xl font-semibold tracking-tight">產品方向校準會議</h1><p className="mt-2 text-sm text-[#787774]">Meeting #{meetingId}</p></div>
