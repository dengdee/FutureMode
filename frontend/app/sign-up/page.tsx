...
export default function SignUpPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    if (password.length < 8) { setError("密碼至少需要 8 碼。"); return; }
    setLoading(true);
    try {
