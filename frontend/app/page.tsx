    ...
    <main className="min-h-screen bg-[#fbfbfa] text-[#1f1f1f]">
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
        ...
        <div className="flex items-center gap-5 text-sm text-[#787774]">
          ...
          <Link href="/dashboard" className="rounded-lg bg-[#2383e2] px-4 py-2 font-medium text-white hover:bg-[#1f76c9]">開啟工作區</Link>
        </div>
      </nav>

      <section className="mx-auto max-w-6xl px-6 pb-24 pt-20 sm:pt-28">
        <div className="max-w-3xl">
          <p className="mb-5 text-sm font-semibold uppercase tracking-[0.18em] text-[#2383e2]">AI teammate for better meetings</p>
          ...
          <div className="mt-9 flex flex-wrap gap-3"><Link href="/dashboard" className="rounded-lg bg-[#2383e2] px-5 py-3 font-medium text-white hover:bg-[#1f76c9]">開始使用</Link><a href="#how-it-works" className="rounded-lg border border-[#e6e6e3] bg-white px-5 py-3 font-medium hover:bg-[#f7f7f5]">了解更多</a></div>
        </div>
