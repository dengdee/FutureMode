...
export default function NewMeetingPage() {
  ...
  useEffect(() => {
    ...
    }).catch((cause) => setError(cause instanceof Error ? cause.message : "無法讀取團隊。"));
  }, [searchParams]);
  ...
  return <AppShell><PageHeader eyebrow="New meeting" title="建立會議" description="從一個團隊建立會議，並一次完成基本議程設定。" />
