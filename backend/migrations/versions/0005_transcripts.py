"""Create transcript segments used by live meeting capture."""
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("speaker_user_id", postgresql.UUID(as_uuid=True), nullable=True),
        ...
        sa.UniqueConstraint("meeting_id", "speaker_user_id", "sequence", name="uq_transcript_sequence"),
    )
